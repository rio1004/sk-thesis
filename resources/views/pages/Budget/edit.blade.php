            ...
            <div class="row justify-content-center py-sm-3 py-md-5">
                <div class="col-sm-10 col-md-8">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control " id="block-form1-username" name="fy_year" value="{{$budget->fy_year}}" placeholder="Enter Year.">
                    </div>
                    <div class="form-group">
                        <label for="block-form1-username">Initial Budget</label>
                        <input type="number" class="form-control " id="block-form1-username" name="initial_budget" value="{{$budget->initial_budget}}" placeholder="Enter Initial Budget.">
                    </div>
                    <div class="form-group">
