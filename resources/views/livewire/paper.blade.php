<div>
    <h2 class="content-heading">Your Barangay's Announcement</h2>
    ...
    <h2 class="content-heading">SK Federation's Announcement</h2>
    <div class="row justify-content-center py-sm-3 py-md-5" >
        @forelse ($brgyAnnouncements as $announcement)
        <div class="col-md-6 col-xl-3">
            <!-- Bottom Right Success -->
            <div class="block block-rounded">
                @if ($announcement->status ==1)
                <div class="block-content block-content-full ribbon ribbon-warning" wire:click="showAnnounceAdmin({{$announcement->id}})">
                    <div class="ribbon-box">
                        Fairly Important
                    </div>
                    <div class="text-center py-4">
                ...
                @elseif ($announcement->status ==2)
                <div class="block-content block-content-full ribbon ribbon-danger" wire:click="showAnnounceAdmin({{$announcement->id}})">
                    <div class="ribbon-box">
                        Very Important
                    </div>
                    <div class="text-center py-4">
                ...
                @else
                <div class="block-content block-content-full ribbon ribbon-success" wire:click="showAnnounceAdmin({{$announcement->id}})">
                    <div class="ribbon-box">
                        Important
                    </div>
                    <div class="text-center py-4">
